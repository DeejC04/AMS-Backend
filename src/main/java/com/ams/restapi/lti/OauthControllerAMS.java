 ...
 */
@Controller
public class OauthControllerAMS {
    private static final Logger LOG = LogManager.getLogger(OauthControllerAMS.class);
    ...
    @Autowired
    private OauthControllerAMS(ConfigService configService, OauthTokenService oauthTokenService, LtiSessionService ltiSessionService) {
